...
import com.taobao.firstbundle.fragment.FirstBundleBlankFragment;
import com.taobao.publicBundle.Tools;

public class FirstBundleActivity extends AppCompatActivity
    implements FirstBundleBlankFragment.OnFragmentInteractionListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //        bundleCompile
        Log.e("providedComple awb",
              "invoke tools at public bundle  Tools.getCurrentTime() > " + Tools.getCurrentTime());
