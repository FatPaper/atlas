...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
        ...
        public boolean onNavigationItemSelected(@NonNull MenuItem item) {
            switch (item.getItemId()) {
                case R.id.navigation_home:
                    switchToFragment("home", "atlas.fragment.intent.action.FIRST_FRAGMENT");
                    Toast.makeText(RuntimeVariables.androidApplication, "on click", Toast.LENGTH_SHORT).show();
                    return true;
                case R.id.navigation_dashboard:
                    switchToFragment("second", "atlas.fragment.intent.action.SECONDBUNDLE_FRAGMENT");
                    return true;
                case R.id.navigation_notifications:
                    new AlertDialog.Builder(MainActivity.this, R.style.Theme_AppCompat_Dialog_Alert).setPositiveButton(
                        android.R.string.cancel,
                        null).setCancelable(true).create().show();
    ...
    public void switchToFragment(String key, String fragmentName) {
        ...
        RemoteFactory.requestRemote(RemoteFragment.class,
                                    MainActivity.this,
                                    new Intent(fragmentName),
